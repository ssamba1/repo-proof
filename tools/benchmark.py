...
def render_markdown(t1: list[dict], t2: list[dict] | None) -> str:
    ...
    lines += [
        ...
        "snippet, not a CLI invocation) — so ~**13/16 handled correctly**, up from ~6/16 before the",
        "extractor was hardened against this corpus. The remaining miss is a README that buries",
        "usage beneath a long distro-specific install matrix (e.g. ripgrep).",
        "",
